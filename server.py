...
def create_app():
    ...
    app.add_url_rule('/pit_stops', view_func=views.pit_stops, methods=["GET"])
    app.add_url_rule('/pit_stops/add', view_func=views.add_pit_stop, methods=["POST"])
    app.add_url_rule('/pit_stops/delete/<identifier>', view_func=views.delete_pit_stop, methods=["POST"])
    app.add_url_rule('/pit_stops/update/<identifier>', view_func=views.update_pit_stop, methods=["GET","POST"])
